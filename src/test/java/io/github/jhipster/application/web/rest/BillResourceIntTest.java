...
public class BillResourceIntTest {
    ...
    private static final String DEFAULT_MUTATION_ID = "AAAAAAAAAA";
    private static final String UPDATED_MUTATION_ID = "BBBBBBBBBB";
    ...
    public void createBill() throws Exception {
        ...
        assertThat(testBill.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testBill.getAmount()).isEqualTo(DEFAULT_AMOUNT);
        assertThat(testBill.getPaymentDate()).isEqualTo(DEFAULT_PAYMENT_DATE);
        assertThat(testBill.getMutationId()).isEqualTo(DEFAULT_MUTATION_ID);
    }
    ...
    public void getAllBills() throws Exception {
        ...
        restBillMockMvc.perform(get("/api/bills?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mutationId").value(hasItem(DEFAULT_MUTATION_ID.toString())));
    }
    ...
    public void getBill() throws Exception {
        ...
        restBillMockMvc.perform(get("/api/bills/{id}", bill.getId()))
            ...
            .andExpect(jsonPath("$.mutationId").value(DEFAULT_MUTATION_ID.toString()));
    }
    ...
    public void updateBill() throws Exception {
        ...
        updatedBill
            ...
            .mutationId(UPDATED_MUTATION_ID);
        ...
        Bill testBill = billList.get(billList.size() - 1);
        assertThat(testBill.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testBill.getAmount()).isEqualTo(UPDATED_AMOUNT);
        assertThat(testBill.getPaymentDate()).isEqualTo(UPDATED_PAYMENT_DATE);
        assertThat(testBill.getMutationId()).isEqualTo(UPDATED_MUTATION_ID);
    }
